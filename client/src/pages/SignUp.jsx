...
export default function SignUp() {
  ...
  function isStep1Ready() {
    ...
    const fullNameValid = name && name.length <= 100 && /^[A-Za-z\s]+$/.test(name)
    const schoolValid = school && school.length <= 100
    const emailValid = /^\S+@\S+\.\S+$/.test(email)
    const passwordValid = Object.values(passwordChecks(form.password || '')).every(Boolean)
    return fullNameValid && schoolValid && emailValid && passwordValid
  }
          ...
          <>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Basic details for your trainee profile.</CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <p
                        className={
                          form.fullName.length > 80 ? 'text-red-600 font-semibold' : 'text-muted-foreground'
                        }
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <p
                        className={
                          form.school.length > 80 ? 'text-red-600 font-semibold' : 'text-muted-foreground'
                        }
                      >
            ...
            <div className="flex justify-end">
              <Button type="button" className="h-10 px-8" onClick={handleNext} disabled={!isStep1Ready()}>
                Next
              </Button>
            </div>
